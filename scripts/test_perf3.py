...
def run_simulation_step_c(state, neighbors, K_csr, target_trace, emit_trace, MAX_PHI, DECAY, MORTALITY_RATE, WALK_STEPS, world_mode='A'):
    ...
    for step in range(WALK_STEPS):
        w0 = time.time()
        c_nodes = neighbors[state.pos] # (N_AGENTS, K_RING)
    ...
    for t in range(3):
        ...
        w_macro_all = (1.0 - e_norm_all) * (1.0 - t_norm_all)
...
def run_world_c_tournament():
    ...
    print("🌌 [REA-7N-C] Booting Cybernetic Control Tournament (Fully Vectorized)")
