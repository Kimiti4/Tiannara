defmodule TiannaraRuntime.Cognitive.Decision.DecisionScore do
  defstruct [:id, :candidate_id, :mission_value, :scientific_value, :mathematical_value, :risk_score, :cost, :memory, :simulation_budget, :resource_util, :constitutional_simplicity, :optionality, :fingerprint, :schema_version, :ontology_version, :created_with_phase, :migration_version]
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      ...
      mission_value: fields[:mission_value], scientific_value: fields[:scientific_value],
      mathematical_value: fields[:mathematical_value], risk_score: fields[:risk_score],
      cost: fields[:cost], memory: fields[:memory],
      simulation_budget: fields[:simulation_budget], resource_util: fields[:resource_util],
      constitutional_simplicity: fields[:constitutional_simplicity], optionality: fields[:optionality],
