defmodule TiannaraRuntime.Cognitive.Decision.ExecutionAuthorization do
  defstruct [:id, :session_id, :candidate_id, :decision_id, :state, :authorized_at, :fingerprint, :schema_version, :ontology_version, :created_with_phase, :migration_version]
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      id: id, session_id: fields[:session_id], candidate_id: fields[:candidate_id],
      decision_id: fields[:decision_id], state: fields[:state] || :pending,
