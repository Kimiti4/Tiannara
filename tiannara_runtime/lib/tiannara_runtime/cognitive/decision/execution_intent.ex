defmodule TiannaraRuntime.Cognitive.Decision.ExecutionIntent do
  defstruct [:id, :session_id, :authorization_id, :mission, :plan, :alternative, :policy_fingerprint, :replay_root, :fingerprint, :schema_version, :ontology_version, :created_with_phase, :migration_version]
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      id: id, session_id: fields[:session_id], authorization_id: fields[:authorization_id],
      mission: fields[:mission], plan: fields[:plan], alternative: fields[:alternative],
      policy_fingerprint: fields[:policy_fingerprint], replay_root: fields[:replay_root],
