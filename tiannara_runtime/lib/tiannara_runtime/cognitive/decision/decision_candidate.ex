defmodule TiannaraRuntime.Cognitive.Decision.DecisionCandidate do
  defstruct [:id, :session_id, :plan_id, :score, :policies, :risk, :fingerprint, :schema_version, :ontology_version, :created_with_phase, :migration_version]
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      id: id, session_id: fields[:session_id], plan_id: fields[:plan_id],
      score: fields[:score], policies: fields[:policies] || [], risk: fields[:risk],
