defmodule TiannaraRuntime.Cognitive.Decision.DecisionEvidence do
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      id: id, session_id: fields[:session_id], stage: fields[:stage],
      input_hash: fields[:input_hash], output_hash: fields[:output_hash],
