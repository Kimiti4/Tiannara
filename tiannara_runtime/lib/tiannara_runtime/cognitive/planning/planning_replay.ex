defmodule TiannaraRuntime.Cognitive.Planning.PlanningReplay do
  defstruct [:id, :session_id, :root, :sequence, :hashes, :fingerprint, :schema_version, :ontology_version, :created_with_phase, :migration_version]
