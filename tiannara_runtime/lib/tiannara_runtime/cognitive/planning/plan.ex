defmodule TiannaraRuntime.Cognitive.Planning.Plan do
  defstruct [:id, :name, :goal_ids, :task_graph, :alternatives, :chosen_alternative, :constraints, :status, :fingerprint, :schema_version, :ontology_version, :created_with_phase, :migration_version]
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      id: id,
      name: fields.name,
      goal_ids: fields.goal_ids || [],
      task_graph: fields.task_graph || %{},
      alternatives: fields.alternatives || [],
      chosen_alternative: fields.chosen_alternative,
