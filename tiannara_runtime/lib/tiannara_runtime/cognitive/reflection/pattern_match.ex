defmodule TiannaraRuntime.Cognitive.Reflection.PatternMatch do
  defstruct [:id, :pattern_id, :outcome_id, :match_strength, :matched_attributes, :context, :fingerprint, :schema_version, :ontology_version, :created_with_phase]
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      id: id,
      pattern_id: Map.get(fields, :pattern_id),
      outcome_id: Map.get(fields, :outcome_id),
      match_strength: Map.get(fields, :match_strength, 0.0),
      matched_attributes: Map.get(fields, :matched_attributes, []),
  ...
  def generate_id(fields) do
    base = "#{Map.get(fields, :pattern_id)}_#{:erlang.unique_integer([:positive])}"
