defmodule TiannaraRuntime.Cognitive.Reflection.LessonApplication do
  defstruct [:id, :lesson_id, :session_id, :applied_to, :result, :effectiveness, :fingerprint, :schema_version, :ontology_version, :created_with_phase]
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      id: id,
      lesson_id: Map.get(fields, :lesson_id),
      session_id: Map.get(fields, :session_id),
      applied_to: Map.get(fields, :applied_to),
      result: Map.get(fields, :result),
      effectiveness: Map.get(fields, :effectiveness, 0.0),
