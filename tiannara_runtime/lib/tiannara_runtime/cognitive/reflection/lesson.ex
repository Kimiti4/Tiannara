defmodule TiannaraRuntime.Cognitive.Reflection.Lesson do
  defstruct [:id, :session_id, :lesson_type, :description, :applicability, :success_rate, :source_pattern_id, :source_outcome_id, :fingerprint, :schema_version, :ontology_version, :created_with_phase]
  ...
  def new(fields) do
    ...
    struct = %__MODULE__{
      ...
      lesson_type: Map.get(fields, :lesson_type),
      description: Map.get(fields, :description, ""),
      applicability: Map.get(fields, :applicability, []),
      success_rate: Map.get(fields, :success_rate, 0.0),
      source_pattern_id: Map.get(fields, :source_pattern_id),
      source_outcome_id: Map.get(fields, :source_outcome_id),
