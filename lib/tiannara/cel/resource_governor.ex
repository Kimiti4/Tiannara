defmodule Tiannara.CEL.ResourceGovernor do
  use GenServer
  require Logger
  ...
  @impl true
  def init(_opts) do
    Logger.info("ResourceGovernor: stub service initialized (Phase 3).")
    {:ok, %{}}
  end
  ...
  def handle_call(:constitutional_score, _from, state) do
    {:reply, Tiannara.CEL.Kernel.ConstitutionalScore.default(:resource_governor), state}
  end
end
